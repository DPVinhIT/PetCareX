...
BEGIN
    ...
    ALTER TABLE dbo.AccountLoginCustomer NOCHECK CONSTRAINT ALL;
    ...
    ALTER TABLE dbo.OrderService NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.OrderSDetail NOCHECK CONSTRAINT ALL;
    ...
    SET @sql = 'BULK INSERT dbo.OrderService FROM ''' + @CsvPath + 'OrderService.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into OrderService';

    SET @sql = 'BULK INSERT dbo.OrderSDetail FROM ''' + @CsvPath + 'OrderSDetail.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into OrderSDetail';
    ...
    SET @sql = 'BULK INSERT dbo.SurgeryChecklistTemplate FROM ''' + @CsvPath + 'SurgeryChecklistTemplate.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into SurgeryChecklistTemplate';

    SET @sql = 'BULK INSERT dbo.NurseAssignment FROM ''' + @CsvPath + 'NurseAssignment.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into NurseAssignment';

    SET @sql = 'BULK INSERT dbo.NurseTask FROM ''' + @CsvPath + 'NurseTask.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into NurseTask';
    ...
    SET @sql = 'BULK INSERT dbo.AccountLoginCustomer FROM ''' + @CsvPath + 'AccountLoginCustomer.csv'' WITH (FIELDTERMINATOR = '','', ROWTERMINATOR = ''\n'', FIRSTROW = 2, CODEPAGE = ''65001'', TABLOCK, MAXERRORS = 1000)';
    EXEC sp_executesql @sql;
    PRINT 'Inserted into AccountLoginCustomer';
    
    -- Re-enable constraints
    PRINT 'Re-enabling foreign key constraints...';
    
    ALTER TABLE dbo.AccountLogin CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.AccountLoginCustomer CHECK CONSTRAINT ALL;
    ...
    ALTER TABLE dbo.OrderService CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.OrderSDetail CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.Discount CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.SurgeryChecklistTemplate CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.NurseAssignment CHECK CONSTRAINT ALL;
    ALTER TABLE dbo.NurseTask CHECK CONSTRAINT ALL;
...
BEGIN
    ...
    ALTER TABLE dbo.OrderSDetail NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.Discount NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.SurgeryChecklistTemplate NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.NurseAssignment NOCHECK CONSTRAINT ALL;
    ALTER TABLE dbo.NurseTask NOCHECK CONSTRAINT ALL;

    PRINT 'Disabling foreign key constraints...';
    
    -- Delete in reverse order of FK dependencies
    DELETE FROM dbo.NurseTask; PRINT 'Deleted from NurseTask';
    DELETE FROM dbo.NurseAssignment; PRINT 'Deleted from NurseAssignment';
    DELETE FROM dbo.SurgeryChecklistTemplate; PRINT 'Deleted from SurgeryChecklistTemplate';
    DELETE FROM dbo.AccountLogin; PRINT 'Deleted from AccountLogin';
    DELETE FROM dbo.AccountLoginCustomer; PRINT 'Deleted from AccountLoginCustomer';
    DELETE FROM dbo.OrderSDetail; PRINT 'Deleted from OrderSDetail';
    DELETE FROM dbo.OrderService; PRINT 'Deleted from OrderService';
...
-- Check record counts in all 41 tables
...
BEGIN
    ...
    INSERT INTO #TableStats VALUES ('OrderService', (SELECT COUNT(*) FROM dbo.OrderService));
    INSERT INTO #TableStats VALUES ('OrderSDetail', (SELECT COUNT(*) FROM dbo.OrderSDetail));
    INSERT INTO #TableStats VALUES ('AccountLogin', (SELECT COUNT(*) FROM dbo.AccountLogin));
    INSERT INTO #TableStats VALUES ('AccountLoginCustomer', (SELECT COUNT(*) FROM dbo.AccountLoginCustomer));
    INSERT INTO #TableStats VALUES ('SurgeryChecklistTemplate', (SELECT COUNT(*) FROM dbo.SurgeryChecklistTemplate));
    INSERT INTO #TableStats VALUES ('NurseAssignment', (SELECT COUNT(*) FROM dbo.NurseAssignment));
    INSERT INTO #TableStats VALUES ('NurseTask', (SELECT COUNT(*) FROM dbo.NurseTask));
